            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0">
                <div className="space-y-4">
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-2 border-b border-border/50 pb-4">
                      <div className="w-20 h-20 bg-blush/30 rounded-md overflow-hidden flex-shrink-0">

...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "pressynstudio-design-xpcro.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "c9f40d1a1608d64e5f4a224f2ad476af";

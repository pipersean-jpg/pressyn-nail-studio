...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Handcrafted luxury press-on nails. Salon-quality wear in minutes, designed for the modern woman." },
      { name: "author", content: "Pressynstudio" },
      ...
      { property: "og:site_name", content: "Pressynstudio" },
